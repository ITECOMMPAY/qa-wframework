...
namespace Codeception\Lib\WFramework\ProxyWebElement;
...
class ProxyWebElement extends RemoteWebElement
{
    ...
    public function executeActions() : ProxyWebDriverActions
    {
        $this->refresh();

        $webDriverActions = new WebDriverActions($this->webDriver);

        return new ProxyWebDriverActions($webDriverActions, $this);
    }
