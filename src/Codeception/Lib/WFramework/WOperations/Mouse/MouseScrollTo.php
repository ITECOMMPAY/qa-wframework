...
class MouseScrollTo extends AbstractOperation
{
    ...
    public function apply(WPageObject $pageObject)
    {
        ...
        $topOffset = $this->topOffset ?? (int) TestProperties::getValue('topBarHeight', 0);

        $pageObject->getProxyWebElement()->executeScriptOnThis(static::SCRIPT_SCROLL_INTO_VIEW, [$topOffset]);
    }
