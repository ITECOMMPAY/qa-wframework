...
use Codeception\Lib\WFramework\WOperations\Mouse\MouseScrollBy;
use Codeception\Lib\WFramework\WOperations\Mouse\MouseScrollTo;
use Imagick;
...
class GetScreenshot extends AbstractOperation
{
    ...
    protected function inSticky(WPageObject $pageObject) : bool
    {
        ...
        $result = $pageObject->getProxyWebElement()->executeScriptOnThis(static::SCRIPT_ELEMENT_IN_STICKY);
