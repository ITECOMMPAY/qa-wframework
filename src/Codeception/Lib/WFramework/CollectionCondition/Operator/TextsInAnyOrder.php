...
class TextsInAnyOrder extends CCond
{
    ...
    {
        return 'элементы в коллекции должны иметь следующие строки, в любом порядке: ' . implode(', ', $this->expectedValue);
    }
