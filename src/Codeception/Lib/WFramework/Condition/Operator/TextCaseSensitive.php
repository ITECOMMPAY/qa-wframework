...
class TextCaseSensitive extends Cond
{
    ...
    {
        $this->actualValue = trim(preg_replace(static::BLANK, ' ', $facadeWebElement->get()->text()));
    ...
    {
        return "видимый текст должен соответствовать '$this->expectedValue' (с учётом регистра)";
    }
