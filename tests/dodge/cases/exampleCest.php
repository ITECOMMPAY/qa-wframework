 ...
 *
 * Прогон локально:    ./vendor/bin/codecept run cases exampleCest -c ./tests/dodge --env dodge-loc,dodge-loc-chrome,dodge-loc-1920
 * Через BrowserStack: ./vendor/bin/codecept run cases exampleCest -c ./tests/dodge --env dodge-bs,dodge-bstack-chrome,dodge-bstack-1920,dodge-windows
 *
 * @package dodge\cases
 */
class exampleCest
