...
use Common\Module\WFramework\Exceptions\SeleniumServerModule\PortAlreadyInUseException;
...
use Common\Module\WFramework\Helpers\UnixProcess;
...
class SeleniumServerModule extends CodeceptionModule
{
    ...
    const SELENIUM_BIN_PATH = '/../SeleniumBin';
